    ...
    public function up()
    {
        if ( ! Schema::hasTable( 'nexopos_products' ) ) {
            Schema::createIfMissing( 'nexopos_products', function( Blueprint $table ) {
                ...
                $table->string( 'barcode' )->nullable(); // works if the product type is "product"
                $table->string( 'barcode_type' )->nullable(); // works if the product type is "product"
                $table->string( 'sku' )->nullable(); // works if the product type is "product"
