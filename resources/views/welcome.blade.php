    ...
    <div id="page-container" class="h-full w-full flex">
        <div class="container flex-auto flex-col items-center justify-center flex m-4 sm:mx-auto">
            <div class="flex justify-center items-center py-6">
                <img class="h-20" src="{{ asset( 'svg/nexopos-variant-1.svg' ) }}" alt="Labsdel">
            </div>
            <div class="ns-box rounded shadow w-full md:w-1/2 lg:w-1/3 overflow-hidden">
                <div id="section-header" class="ns-box-header p-4">
                    <p class="text-center b-8 text-sm">{{ __( "If you see this page, this means Labsdel is correctly installed on your system. This page shows useful links that will take you to the important resources." ) }}</p>
                </div>
