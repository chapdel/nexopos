...
use App\Http\Middleware\HasLicenseMiddleware;
...
Route::group(['middleware' => [HasLicenseMiddleware::class]], function(){
    Route::get( '/license', [LicenseController::class, 'show' ])->name( ns()->routeName( 'ns.license.form' ) );
    Route::post( '/license', [LicenseController::class, 'update' ])->name( ns()->routeName( 'ns.license.update' ) );
});